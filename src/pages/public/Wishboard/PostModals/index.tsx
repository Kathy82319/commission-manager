        ...
        <form onSubmit={onSubmit} className="post-form" style={{ padding: '24px', gap: '20px' }}>
          <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
            ...
            <div className="form-group" style={{ width: '240px', flexShrink: 0 }}>
              ...
              {postForm.ref_image_key ? (
                <div style={{ position: 'relative', width: '100%', height: '320px', borderRadius: '8px', overflow: 'hidden', border: '1px solid #ddd' }}>
                  ...
                  <button 
                    type="button" 
                    onClick={() => setPostForm({...postForm, ref_image_key: ''})} 
                    style={{ position: 'absolute', top: 8, right: 8, background: 'rgba(0,0,0,0.6)', color: 'white', border: 'none', borderRadius: '50%', cursor: 'pointer', width: '28px', height: '28px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                  >
                    <X size={16}/>
                  </button>
                </div>
            ...
            <div style={{ flex: '1 1 300px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <div className="form-group">
                ...
                <input 
                  type="text" 
                  placeholder={activeTab === 'offer' ? "例如：接長期立繪、Q版頭貼" : "簡單描述你的需求"} 
          ...
          <div className="form-group">
            ...
            <div className="tag-selector">
              {PAY_TAGS.map(t => (
                <span 
                  key={t} 
                  className={`selectable-tag ${postForm.payment_methods.includes(t) ? 'selected' : ''}`} 
          ...
          <div className="form-group">
            ...
            <div className="tag-selector">
              {REQ_TAGS.map(t => (
                <span 
                  key={t} 
                  className={`selectable-tag ${postForm.tags.includes(t) ? 'selected' : ''}`} 
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', paddingTop: '8px' }}>
            <button 
              ...
              style={{ background: '#ff8c00', color: 'white', padding: '12px 28px', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '15px', boxShadow: '0 4px 12px rgba(255, 140, 0, 0.3)' }}
            >
