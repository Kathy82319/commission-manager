      ...
      <div className="post-modal">
        ...
        <form onSubmit={onSubmit} className="post-form">
              ...
              {(form.ref_images || []).length < 5 && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  <div style={{ width: '120px', height: '120px', border: '2px dashed #cbd5e1', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <ImageUploader onUpload={onImageUpload} targetWidth={1000} buttonText={isUploading ? "上傳中..." : "+ 上傳圖片"} maxSizeMB={3} aspectRatio={1} />
                  </div>
          ...
          <div className="modal-footer">
             ...
             <button type="button" className="btn-cancel" onClick={onSaveDraft}>
    <Save size={16} style={{ marginRight: '4px' }} /> 儲存預設
  </button>
