                ...
                {activeTab === 'background' && (
                  <div className="fade-in oc-form-column">
                    <div style={{ backgroundColor: '#FFF', padding: '16px', borderRadius: '10px', border: '1px solid #EAE6E1' }}>
                      <h4 className="oc-field-label" style={{ fontSize: '16px', fontWeight: 800, color: '#4A3B32', borderBottom: '1px solid #F4F0EB', paddingBottom: '8px', marginBottom: '12px', margin: '0 0 12px 0' }}>角色個性</h4>
                      <OCDashedInput 
                    ...
                    <div style={{ backgroundColor: '#FFF', padding: '16px', borderRadius: '10px', border: '1px solid #EAE6E1' }}>
                      <h4 className="oc-field-label" style={{ fontSize: '16px', fontWeight: 800, color: '#4A3B32', borderBottom: '1px solid #F4F0EB', paddingBottom: '8px', marginBottom: '12px', margin: '0 0 12px 0' }}>人物背景說明</h4>
                      <OCDashedInput 
                    ...
                    <div style={{ backgroundColor: '#FFF', padding: '16px', borderRadius: '10px', border: '1px solid #EAE6E1' }}>
                      <h4 className="oc-field-label" style={{ fontSize: '16px', fontWeight: 800, color: '#4A3B32', borderBottom: '1px solid #F4F0EB', paddingBottom: '8px', marginBottom: '12px', margin: '0 0 12px 0' }}>其他說明</h4>
                      <OCDashedInput 
