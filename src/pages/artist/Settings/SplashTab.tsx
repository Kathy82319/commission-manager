          ...
          {(settings.splash_image || settings.splash_image_mobile) && (
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              {settings.splash_image && (
                <div style={{ flex: '1 1 200px', borderRadius: '8px', overflow: 'hidden', border: '1px solid #EAE6E1' }}>
              ...
              {settings.splash_image_mobile && (
                <div style={{ flex: '0 0 120px', borderRadius: '8px', overflow: 'hidden', border: '1px solid #EAE6E1' }}>
                  <div style={{ fontSize: '12px', color: '#A0978D', padding: '8px 10px', fontWeight: 'bold', background: '#FAFAFA', borderBottom: '1px solid #EAE6E1' }}>📱 目前手機版</div>
